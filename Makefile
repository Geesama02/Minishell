...
CC = cc
NAME = minishell
SRC = main.c parsing/ft_split_qt.c parsing/ft_env_split.c parsing/ft_strcmp.c parsing/fill_token.c execution/builtins.c parsing/create_ast.c \
	...
	signals/signals.c parsing/build_tree_utils.c execution/memory_utils.c parsing/tokenizer_utils4.c\
