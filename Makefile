...
SRC = main.c ft_split.c ft_strcmp.c parsing/fill_token.c ft_strtrim.c execution/builtins.c parsing/create_ast.c ft_strncmp.c \
	...
	execution/redirection.c expanding/wildcard_utils2.c parsing/heredoc.c parsing/heredoc_utils.c parsing/tokenizer_utils3.c \
	execution/builtins_utils.c ft_env_split.c expanding/expanding_env.c expanding/expanding_env_utils.c
OBJS = ${SRC:.c=.o}
LIBFT = ./libft/libft.a
